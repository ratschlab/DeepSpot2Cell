"""
Fetch papers citing DeepSpot2Cell and update README.md.
...
DeepSpot2Cell DOI: 10.1101/2025.09.23.678121
"""
...
DEEPSPOT2CELL_DOI = "10.1101/2025.09.23.678121"
...
def _api_get(url):
    ...
    req = urllib.request.Request(url, headers={"User-Agent": "DeepSpot2Cell-Citation-Bot"})
    try:
...
def fetch_ss_citations():
    ...
    url = (
        f"{SEMANTIC_SCHOLAR_API}/paper/DOI:{DEEPSPOT2CELL_DOI}/citations"
...
def fetch_opencitations_dois():
    ...
    url = f"{OPENCITATIONS_API}/citations/doi:{DEEPSPOT2CELL_DOI}"
    data = _api_get(url)
    if not data:
        return set()
